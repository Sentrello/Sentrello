 ...
 * 10-second window are ever recorded here, and An earlier change's lockout count
 ...
 * less, and until this file's An earlier change that half was invisible in both
...
export const signInEvents = createAuthMiddleware(async (ctx) => {
  ...
  try {
    ...
    // either — the password was right, and An earlier change counts `sign-in.failed`
