...
/**
 * The one addition to a table `users.tsx` already had: `onOpen`,
 ...
 * button for a built-in policy (Admin, Customer) — unchanged here —
 * so until `onOpen` existed there was no way at all to open Admin's record
 * and see who holds it. Rendered, not only reasoned about.
 *
