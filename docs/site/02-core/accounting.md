...
Sentrello keeps **real double-entry books**. Every financial event — an
invoice, a payment, an expense, a bill — posts a journal entry whose debits
equal its credits, or it does not post at all.

That is not bookkeeping theatre. It means the reports are read from the ledger
rather than recalculated from invoices, so they cannot drift apart from what
actually happened.

## Accounts

The chart of accounts is the list of buckets money moves between: bank
accounts, income, expenses, money owed to you, money you owe. A starter chart
is created for you and you can add to it.

## Money in and out

The main screen answers the question a business actually asks — what came in,
what went out, and what is left. Expenses are recorded here with a category, a
...
ledger rather than recalculated, so they agree with the journal by construction.
...
category, aged receivables and payables, and CSV export. The free books stay
